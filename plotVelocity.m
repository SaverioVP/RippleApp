function plotVelocity(axesHandle, pos_data)
    ...
    % Plot x vs y
    hPlot = plot(axesHandle, pos_data.t, pos_data.v, '-.');  % Dotted line with circles at points

    % Set labels and title
    xlabel(axesHandle, 'time (s)');
    ylabel(axesHandle, 'Velocity (cm/s)');
    title(axesHandle, 'Animal Velocity');
